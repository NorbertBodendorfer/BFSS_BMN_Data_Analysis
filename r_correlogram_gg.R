...
PrintScriptName("R correlogram script using ggplot2")
...
plot_file_name <- p("correlogram_gg_", file_pattern, ".pdf")
...
printf("Making Correlogram... ")



gg_corr <- ggpairs(data=all_data, title = pairs_title, lower = list(continuous = "density"), diag = list(continuous = "barDiag")) 


suppressMessages(ggsave(plot_file_name, gg_corr))
